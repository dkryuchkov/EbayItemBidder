...
import bidder.Gumtree;
import bidder.GumtreeOtherException;
import bidder.Helper;
import bidder.HtmlParser;
import bidder.ImageRecog;
...
public class Renewer implements Runnable {

    private ImageRecog imageRecog = null;

    static private final String adminEmail = "info@virtualcolleague.com.au";
    static final String const_MyAdClass = "my-adlisting-ad my-adlisting-ad-outer enabled";
    static final String const_GraysCondition = "entity.condition=";
    static final String const_GSTnote = "GST is included in the final bid price of this item.|GST is included in the buyers premium.|GST will be added to the final bid price of this item.|GST will be added to the buyers premium.|GST|Grays|Graysonline|grays|grasonline";
    static final String const_graysImageClass = "thumbs-list-wrapper";
    final static String loginPage = "id=\"login-email\"";
    static final String const_graysLotUrl = "https://www.graysonline.com/lot/<lot>";
    static final Map<String, String> map = new HashMap<String, String>();
    static final String const_parseJSON = "$.parseJSON(";
    static final String const_PostAdForm = "PostAdForm\"}";
    static final String const_MyAddById = "/m-my-ad.html?adId=<id>";
    static final String const_PostEditUrl = "https://www.gumtree.com.au/p-edit-ad.html?adId=1131405831";
    static final String const_PostAddUrl = "https://www.gumtree.com.au/p-post-ad2.html?categoryId=<category>&adType=<type>";
    static final String catJsonUrl = "https://www.gumtree.com.au/p-select-category.json?nodeType=cat&level1id=<id>";
    static final String URL_CATEGORY = "https://www.gumtree.com.au/p-post-ad.html";
    static final String DATA_CAT_ID_PATERN = "data-catid=";
    static final String CAT_ID_PATERN = "categoryId-wrp-option-";
    static final int TIME_OUT = 2 * 1000;
    //String id, String user, String title, short visits
    static final String const_Item = "<id>\n<user>\n<title>\n<page>\n<visits>\n<active>\n<managed>\n<hourstomarket>\n<minvisits>";
    static final String loginError = "show-login-form"; //"Sorry, this email and password combination is not known";
    static final String projectFolder = "C:\\git\\EbayitemBidder\\";
    static final String failedFolder = projectFolder + "failed\\<username>";
    static final String imageFolder = projectFolder + "images\\<username>";
    public static final String tempFolder = projectFolder + "temp\\<username>\\output.bmp";
    static final String messagesFolder = projectFolder + "messages\\<username>";
    static final String templateItem = projectFolder + "templates\\itemTemplate.txt";
    public static final String templateInactiveUserReport = projectFolder + "templates\\inactiveUserReportTemplate.txt";
    public static final String templateActiveUserReport = projectFolder + "templates\\activeUserReportTemplate.txt";
    static final String saveFolder = projectFolder + "saved\\<username>";
    static final String nexPage = "<a class=\"paginator__page-num\"";
    static final String pageNumberSelected = "paginator__page-num--selected\">";
    static final String pageNumberNext = "<a class=\"paginator__page-num\"";
    static final String deleteFile = projectFolder + "delete\\<username>\\delete.txt";
    static final String loadFile = projectFolder + "load\\<username>\\load.txt";
    static final String deleteFolder = projectFolder + "delete\\<username>";
    static final String outFolder = projectFolder + "out\\<username>";
    static public final String show_listing = "https://www.gumtree.com.au/m-my-ad.html?adId=<id>";
    static public final String edit_listing = "https://www.gumtree.com.au/p-edit-ad.html?adId=<id>";
    static private final String url = "https://www.gumtree.com.au/t-login-form.html";
    static private final String data = "targetUrl=&likingAd=false&loginMail=kryuchkov%40hotmail.com&password=16051972&_rememberMe=on";
    static private final String url2 = "https://www.gumtree.com.au/m-my-ads.html?show=ALL&pageNum=<page>";
    static private final String loginUrlPost = "https://www.gumtree.com.au/t-login.html";
    static private final String loginUrlGet = "https://www.gumtree.com.au/t-login-form.html";
    static private final String jsonUrlBase = "www.gumtree.com.au";
    static private final String jsonUrlGet = "/j-cars-specs.json?make=<make>&model=<model>";
    static private final String nvicUrlGet = "https://www.gumtree.com.au/j-car-attributes-defaults.json?code=<nvic>";
    ...
    static private final String bbUserInput = "name=\"bbUserInput\"";
    static private final String onpage = "value c-dark-green\">";
    static private final String loginAgain = "<span class=\"login-text c-hide\">Sign in</span>";
    static private final String baseURL = "https://www.gumtree.com.au";
    static private final String delete = "https://www.gumtree.com.au/m-delete-ad.html?adId=<id>";
    static private final String add = "https://www.gumtree.com.au/p-submit-ad.html";
    static private final String process = BASE_INTFORCE_URL + "/process?token=<token>";
    static private final String userURL = BASE_INTFORCE_URL + "/process?token=<token>&user=<user>";
    static private final String messageURL = BASE_INTFORCE_URL + "/process?token=<token>&user=<user>&message=<message>";
    static private final String statusURL = BASE_INTFORCE_URL + "/process?token=<token>&user=<user>&status=<status>";
    static private final String itemURL = BASE_INTFORCE_URL + "/process?token=<token>&user=<user>&item=<item>";
    static private final String addtopostURL = BASE_INTFORCE_URL + "/process?token=<token>&user=<user>&addtopost=<addtopost>";
    static private final String itemIdURL = BASE_INTFORCE_URL + "/process?token=<token>&item=<item>";
    static private final String bb_image = "https://www.gumtree.com.au/bb-image.html?tok=<id>";
    static private final String pleaseEnterVC = "please enter a correct verification code|please enter the validation code below";
    static private final String bb_token = "data-token=\"";
    static private final String removeAlways = "bbUserInput,ctk,csrft,bbToken";
    static private final String exclusionCategoriesTeplate = "<dd class=\"rs-ma-details-category\"><category></dd>";
    static private final String exclusionCategories = "Cars, Vans & Utes";
    static final String SELECT_PAID = "You must select a paid Ad Type";

    static private final String addAlways = "_renew=on,_showLocationOnMap=on,repost=false,streetName= ;"
    ...
    static private final String addMatch = "shared_accomodation.availabilitystartdate=datesMap[shared_accomodation.availabilitystartdate],pstad-lat=geocodeLat,"
    ...
    static private final String addMatchPart = "postad-img-=images";
    static private final String strMatchListOfNonQuotedAttrs = "short_term.";
    static private final String addMatchSpecial = ".condition_s";
    //"cars.carmake_s,cars.forsaleby_s,"
    static private final Map<String, String> mapAlwaysRemove = new HashMap<>();
    static private final Map<String, String> mapAlways = new HashMap<>();
    static private final Map<String, String> mapListOfSpecialDatePeriodAttrs = new HashMap<>();
    static private final Map<String, String> mapMatch = new HashMap<>();
    static private final Map<String, String> mapMatchPart = new HashMap<>();
    static private final String bbInput = "bbUserInput=5628,bbToken=1e5236ded5e8903554adb153c86607c1add9e8794d939aefaf5f3830fb539fda9222231a9c51c7e0ee6abaf33bddf0bdc911fcfec64ca6888c124006e8c7ee0a";
    static private final String bbInputText = " verification code.";
    static private final int maxPage = 1;
    static private final String strListOfSpecialDatePeriodAttrs = "short_term.availability_mtdtcsv=dateRangeMap[short_term.availability.availabilitystartdate];dateRangeMap[short_term.availability.availabilityenddate]";
    static private final String const_postImageUrl = "https://www.gumtree.com.au/p-upload-image.html";
    static private final String const_ImageUrl = "https://i.ebayimg.com";

    static final boolean repostAll = false;
    ...
    public static JsonObject jsonSchedule = null;
    ...
    private Map<String, String> loadCategories() {
        ...
        try {
            ...
            for (String cat : Helper.split(page, DATA_CAT_ID_PATERN, ">")) {
                ...
                new Renewer(null).loadJsonCats(cat, null);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        ...
        while (true) {
            while (out.trim().length() > 0 && !(login && out.trim().contains(loginError))) {
                ...
                if ((lastResponseCode == HttpStatus.SC_INTERNAL_SERVER_ERROR && i < 3)
                    ...
                    out = out.substring(0, out.indexOf("\""));
                    int r = randInt(51, 69);
                    String bbUserInputValue = imageRecog.getNumber(bb_image.replace("<id>", out), username, 68); //getBbUserInput(bb_image.replace("<id>", out));
    ...
    private static synchronized void text(String txt) {
        ...
        if (Gumtree.out != null && !text.contains("Retrying...")) {
            Gumtree.out.println(text);
            Gumtree.out.flush();
        }
    }
...
//{"XLargeAlias":"extraLarge","XLargeSizeId":20,"XLargeUrl":"https://i.ebayimg.com/00/s/NjAwWDgwMA==/z/5ZUAAOSwa~BYPpRW/$_20.JPG","XXLargeAlias":"extraExtraLarge","XXLargeUrl":"https://i.ebayimg.com/00/s/NjAwWDgwMA==/z/5ZUAAOSwa~BYPpRW/$_57.JPG","emailUrl":"https://i.ebayimg.com/00/s/NjAwWDgwMA==/z/5ZUAAOSwa~BYPpRW/$_8.JPG","largeAlias":"large","largeSizeId":75,"largeUrl":"https://i.ebayimg.com/00/s/NjAwWDgwMA==/z/5ZUAAOSwa~BYPpRW/$_75.JPG","logoSizeId":26,"logoUrl":"https://i.ebayimg.com/00/s/NjAwWDgwMA==/z/5ZUAAOSwa~BYPpRW/$_26.JPG","mediumAlias":"medium","mediumSizeId":35,"mediumUrl":"https://i.ebayimg.com/00/s/NjAwWDgwMA==/z/5ZUAAOSwa~BYPpRW/$_35.JPG","normalAlias":"normal","teaserAlias":"teaser","teaserSizeId":74,"teaserUrl":"https://i.ebayimg.com/00/s/NjAwWDgwMA==/z/5ZUAAOSwa~BYPpRW/$_74.JPG","thumbnailAlias":"thumbnail","thumbnailSizeId":14,"thumbnailUrl":"https://i.ebayimg.com/00/s/NjAwWDgwMA==/z/5ZUAAOSwa~BYPpRW/$_14.JPG","status":"OK"}                
    ...
    public void run() {
        try {
            username = ((JsonObject) jsonObject).getString("email");
            if (((JsonObject) jsonObject).getBoolean("enabled")) {
                int plan = ((JsonObject) jsonObject).getInt("plan");
                if (isClUser(username) && plan > 0) {
                    text("Started for: " + username);
                    password = ((JsonObject) jsonObject).getString("password");

                    if (login(true)) {
                        imageRecog = new ImageRecog(username);
                        sendMessages();
                        if (!ItemBidder.isInAU()) {
                            loadFailed(true);
                        }
                        ...
                        if (ItemBidder.isInAU()) {
                            ...
                            list = deleteAdv(list);
                            updateItems(list);
                            if (containsItem(jsonSchedule.getJsonArray("users"), (JsonObject) jsonObject)) {
                                renewAdv();
                            }
                        } else {
